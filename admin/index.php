                            ...
                            <form method="POST" action="">
                                <div class="activity-card-calendar">
                                        ...
                                        <div class="input-group mb-3">
                                            <input id="datePickerId" value="2024-01-01" name="date1" type="date" data-date-inline-picker="true" />
                                        </div>
                                        <div class="input-group mb-3">
                                            <input id="datePickerId" value="2024-12-30" name="date2" type="date" data-date-inline-picker="true" />
                                        </div>
