                        ...
                        <div class="col l-12">
                            ...
                            <div class="home-suggestion">
                                <div class="row">
                                    ...
                                    ?>
                                            <div class="col l-3">
                                                <a style="text-decoration: none;shape-rendering: #333;color: #333;" href="chitietsanpham.php?productId=<?php echo $result['productId'] ?>&&brandId=<?php echo $result['brandId']?>">
                                ...
                                <?php
                                        ...
                                        if($current_page < $product_button-1){
                                            $next_page = $current_page + 1;
                                ?>
